...
export default function ContactForm() {
    ...
    return (
        <div className="relative bg-white px-6 py-24 sm:py-32 lg:px-8">
            {/* Image container behind the form */ }
            <div className="absolute inset-0 top-0 z-0 overflow-hidden">
                <div className="relative w-full h-full">
                    <img
                        src={ contact }
                        alt="Background Image 1"
                        className="object-cover w-full h-1/2 filter blur-sm" // Apply blur here
                    />
                </div>
            </div>
            {/* Form content */ }
            ...
            <form action="#" method="POST" className="relative z-10 mx-auto mt-16 max-w-xl sm:mt-20 rounded-sm shadow-lg px-6 py-12 sm:py-16 lg:px-8">
